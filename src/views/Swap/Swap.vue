...
export default {
  ...
  computed: {
    ...
    min() {
      ...
      const toQuoteAsset =
        this.selectedQuoteProvider?.config?.type === SwapProviderType.HederaBoostNativeToERC20
          ? this.toAssetChain
          : this.toAsset

      const fromQuoteAsset =
        this.selectedQuoteProvider?.config?.type === SwapProviderType.HederaBoostERC20ToNative
          ? this.assetChain
          : this.asset
  ...
  methods: {
    ...
    getAccountId() {
      if (this.selectedQuoteProvider.config.type === SwapProviderType.HederaBoostERC20ToNative) {
